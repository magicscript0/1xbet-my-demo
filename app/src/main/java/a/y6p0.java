...
public abstract class y6p0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Unsafe f39188a;

    public y6p0(Unsafe unsafe) {
        this.f39188a = unsafe;
    }

    public final int a(Class cls) {
        return this.f39188a.arrayBaseOffset(cls);
    }

    public final int b(Class cls) {
        return this.f39188a.arrayIndexScale(cls);
    }
    ...
    public final int f(Object obj, long j) {
        return this.f39188a.getInt(obj, j);
    }

    public final long g(Object obj, long j) {
        return this.f39188a.getLong(obj, j);
    }

    public final Object h(Object obj, long j) {
        return this.f39188a.getObject(obj, j);
    }

    public final long i(Field field) {
        return this.f39188a.objectFieldOffset(field);
    }
