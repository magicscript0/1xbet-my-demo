...
public final /* synthetic */ class ebb0 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final ebb0 f7016a;
    private static final wze0 descriptor;

    static {
        ebb0 ebb0Var = new ebb0();
        f7016a = ebb0Var;
        rh70 rh70Var = new rh70("org.xplatform.statistic.player.impl.referee.referee_team.data.models.RefereeTeamResponse", ebb0Var, 4);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new gbb0(i, num, list, list2, list3);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        gbb0Var.getClass();
        List list = gbb0Var.d;
        Integer num = gbb0Var.c;
        List list2 = gbb0Var.b;
        List list3 = gbb0Var.f10246a;
        wze0 wze0Var = descriptor;
