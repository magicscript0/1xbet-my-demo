...
public abstract class a7p0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final Unsafe f356a;
    public static final Class b;
    public static final x6p0 c;
    ...
    static {
        ...
        if (unsafeJ != null) {
            if (!qy2.a()) {
                u6p0Var = new u6p0(unsafeJ);
            } else if (zF) {
                u6p0Var = new r6p0(unsafeJ, z ? 1 : 0);
            } else if (zF2) {
                u6p0Var = new r6p0(unsafeJ, i);
            }
        }
        c = u6p0Var;
        d = u6p0Var == null ? false : u6p0Var.s();
        e = u6p0Var == null ? false : u6p0Var.r();
        f = c(byte[].class);
        c(boolean[].class);
        d(boolean[].class);
        c(int[].class);
    ...
    public static void a(Throwable th) {
        Logger.getLogger(a7p0.class.getName()).log(Level.WARNING, "platform method missing - proto runtime falling back to safer methods: " + th);
    }
    ...
    public static Unsafe j() {
        try {
            return (Unsafe) AccessController.doPrivileged(new o6p0());
        } catch (Throwable unused) {
            return null;
        }
    }
