...
public final /* synthetic */ class xvr implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final xvr f38679a;
    private static final wze0 descriptor;

    static {
        xvr xvrVar = new xvr();
        f38679a = xvrVar;
        rh70 rh70Var = new rh70("org.xplatform.bethistory.history.data.models.request.GetBetInfoHistoryWithSummaryByDatesRequest", xvrVar, 11);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new zvr(i, strW, iK, jR, jR2, jR3, iK2, list, l, zC, zC2, zC3);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        o0x[] o0xVarArr = zvr.l;
        String str = zvrVar.f41906a;
        Long l = zvrVar.h;
        wccVarA.A(wze0Var, 0, str);
        wccVarA.i(1, zvrVar.b, wze0Var);
        wccVarA.n(wze0Var, 2, zvrVar.c);
        wccVarA.n(wze0Var, 3, zvrVar.d);
        wccVarA.n(wze0Var, 4, zvrVar.e);
        wccVarA.i(5, zvrVar.f, wze0Var);
        wccVarA.m(wze0Var, 6, (xdw) o0xVarArr[6].getValue(), zvrVar.g);
        if (wccVarA.v(wze0Var) || l != null) {
            wccVarA.p(wze0Var, 7, zxy.f41997a, l);
        }
        wccVarA.y(wze0Var, 8, zvrVar.i);
        wccVarA.y(wze0Var, 9, zvrVar.j);
        wccVarA.y(wze0Var, 10, zvrVar.k);
        wccVarA.c(wze0Var);
    }
}
