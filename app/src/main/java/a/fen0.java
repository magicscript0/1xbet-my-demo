...
public final /* synthetic */ class fen0 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final fen0 f8779a;
    private static final wze0 descriptor;

    static {
        fen0 fen0Var = new fen0();
        f8779a = fen0Var;
        rh70 rh70Var = new rh70("org.xplatform.bethistory.history.data.models.response.TotoHistoryItemResponse", fen0Var, 20);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        Long l9 = l4;
        return new jen0(i2, l7, l8, str7, str4, str5, str6, num2, d6, d3, str, num, d5, str2, bool, bool2, l2, l3, list, uysVar, l9);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        jen0 jen0Var = (jen0) obj;
        jen0Var.getClass();
        Long l = jen0Var.t;
        uys uysVar = jen0Var.s;
        List list = jen0Var.r;
        Long l2 = jen0Var.q;
        Long l3 = jen0Var.p;
        Boolean bool = jen0Var.o;
        Boolean bool2 = jen0Var.n;
        String str = jen0Var.m;
        Double d = jen0Var.l;
        Integer num = jen0Var.k;
        String str2 = jen0Var.j;
        Double d2 = jen0Var.i;
        Double d3 = jen0Var.h;
        Integer num2 = jen0Var.g;
        String str3 = jen0Var.f;
        String str4 = jen0Var.e;
        String str5 = jen0Var.d;
        String str6 = jen0Var.c;
        Long l4 = jen0Var.b;
        Long l5 = jen0Var.f15239a;
        wze0 wze0Var = descriptor;
