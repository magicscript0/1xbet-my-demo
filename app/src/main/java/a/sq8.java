...
public final /* synthetic */ class sq8 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final sq8 f30275a;
    private static final wze0 descriptor;

    static {
        sq8 sq8Var = new sq8();
        f30275a = sq8Var;
        rh70 rh70Var = new rh70("org.xplatform.cyber.section.impl.championships.universal.data.model.calendar_tournament.swiss.CalendarTournamentGroupSwissResponse", sq8Var, 6);
        rh70Var.j("id", true);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new uq8(i, str, str2, num, list, list2, list3);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        List list2 = uq8Var.e;
        List list3 = uq8Var.d;
        Integer num = uq8Var.c;
        String str = uq8Var.b;
        String str2 = uq8Var.f33542a;
        wze0 wze0Var = descriptor;
