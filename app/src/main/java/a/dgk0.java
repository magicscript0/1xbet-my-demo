...
public final /* synthetic */ class dgk0 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final dgk0 f5628a;
    private static final wze0 descriptor;

    static {
        dgk0 dgk0Var = new dgk0();
        f5628a = dgk0Var;
        rh70 rh70Var = new rh70("org.xplatform.statistic.player.impl.player.players_statistic_cricket.data.models.TableResponse", dgk0Var, 4);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new lgk0(i, list, list2, list3, list4);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        lgk0Var.getClass();
        List list = lgk0Var.d;
        List list2 = lgk0Var.c;
        List list3 = lgk0Var.b;
        List list4 = lgk0Var.f18552a;
        wze0 wze0Var = descriptor;
