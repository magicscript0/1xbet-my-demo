...
public final /* synthetic */ class a5j implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final a5j f255a;
    private static final wze0 descriptor;

    static {
        a5j a5jVar = new a5j();
        f255a = a5jVar;
        rh70 rh70Var = new rh70("org.xplatform.cyber.game.core.data.model.games.dice.DiceResponse", a5jVar, 4);
        rh70Var.j("S", true);
        rh70Var.j("R", true);
        rh70Var.j("D", true);
        rh70Var.j("T", true);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new c5j(i, str, str2, list, list2);
    }
