...
public final /* synthetic */ class dth0 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final dth0 f6206a;
    private static final wze0 descriptor;

    static {
        dth0 dth0Var = new dth0();
        f6206a = dth0Var;
        rh70 rh70Var = new rh70("org.xplatform.betting.core.mainfeed.SportResponse", dth0Var, 6);
        rh70Var.j("id", true);
        rh70Var.j("name", true);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new vth0(i, bool, l, str, str2, str3, str4);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        vth0 vth0Var = (vth0) obj;
        vth0Var.getClass();
        String str = vth0Var.f;
        String str2 = vth0Var.e;
        Boolean bool = vth0Var.d;
        String str3 = vth0Var.c;
        String str4 = vth0Var.b;
        Long l = vth0Var.f35309a;
        wze0 wze0Var = descriptor;
