    ...
    public final int d(int i) {
        ...
        while (true) {
            ...
            if ((((~j4) << 6) & j4 & (-9187201950435737472L)) != 0) {
                int iE = e(i6);
                long j8 = 255;
                if (this.e != 0 || ((this.f14844a[iE >> 3] >> ((iE & 7) << 3)) & 255) == 254) {
                    j = 255;
                    j2 = j5;
                    i2 = 1;
                    j3 = 128;
                            ...
                            while (i25 != i21) {
                                ...
                                if (j12 != 128 && j12 == 254) {
                                    ...
                                    if (((iE2 - i30) & i21) / 8 == ((i25 - i30) & i21) / 8) {
                                        ...
                                        jArr3[jArr3.length - i13] = (jArr3[i19] & j14) | Long.MIN_VALUE;
                                        i25 = i3 + i13;
                                        i13 = i13;
                                        j11 = j14;
                                        iArr2 = iArr;
                    ...
                    long[] jArr4 = this.f14844a;
                    int[] iArr3 = this.b;
                    int i36 = this.c;
                    f(iB2);
                    long[] jArr5 = this.f14844a;
                    int[] iArr4 = this.b;
                    int i37 = this.c;
                    int i38 = i19;
                    while (i38 < i36) {
                        if (((jArr4[i38 >> 3] >> ((i38 & 7) << 3)) & 255) < j3) {
                            ...
                            int i42 = (iE3 & 7) << 3;
                            jArr = jArr5;
                            long j17 = (jArr5[i41] & (~(255 << i42))) | (j16 << i42);
                            jArr[i41] = j17;
                            jArr[(((iE3 - 7) & i37) + (i37 & 7)) >> 3] = j17;
                            iArr4[iE3] = i39;
                        } else {
                            jArr = jArr5;
                        }
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128 && !j620Var.c(iArr[(i << 3) + i3])) {
                            return false;
                        }
                        j >>= 8;
                    }
