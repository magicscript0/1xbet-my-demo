...
public final class n3a {
    ...
    public final void b() {
        ...
        if (length > 0) {
            ...
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                m3a m3aVar = (m3a) arrayList.get(size);
                int i = m3aVar.c;
                if (i != length) {
                    return;
                }
    ...
    public final aje c(int i) {
        ...
        return new aje(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, null, null, i6, 1, Integer.MIN_VALUE, f, i5, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, -16777216, Integer.MIN_VALUE, 0.0f, 0);
    }
    ...
    public final SpannableString d() {
        ...
        while (true) {
            ...
            m3a m3aVar = (m3a) arrayList.get(i5);
            boolean z2 = m3aVar.b;
            int i7 = m3aVar.f19572a;
            if (i7 != 8) {
                boolean z3 = i7 == 7;
                if (i7 != 7) {
                    i4 = o3a.B[i7];
            ...
            int i8 = m3aVar.c;
            i5++;
            if (i8 != (i5 < arrayList.size() ? ((m3a) arrayList.get(i5)).c : length)) {
                if (i != -1 && !z2) {
    ...
    public final boolean e() {
        return this.f21203a.isEmpty() && this.b.isEmpty() && this.c.length() == 0;
    }
}
