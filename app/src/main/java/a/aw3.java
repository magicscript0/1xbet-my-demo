...
public abstract class aw3 implements TypeEvaluator {
    public static Integer a(float f, Integer num, Integer num2) {
        ...
        float fA = n22.a(f3, f2, f, f2);
        float fA2 = n22.a(fPow4, fPow, f, fPow);
        float fA3 = n22.a(fPow5, fPow2, f, fPow2);
        float fA4 = n22.a(fPow6, fPow3, f, fPow3);
