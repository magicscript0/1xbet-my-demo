...
public final /* synthetic */ class tab implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final tab f31200a;
    private static final wze0 descriptor;

    static {
        tab tabVar = new tab();
        f31200a = tabVar;
        rh70 rh70Var = new rh70("org.xplatform.registration.core.data.models.CityResponse", tabVar, 5);
    ...
    public final xdw[] childSerializers() {
        xdw xdwVarY = vn4.Y((xdw) yab.f[2].getValue());
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new yab(i, iK, iK2, jR, str, list);
    }
