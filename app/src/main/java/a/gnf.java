...
public final /* synthetic */ class gnf implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final gnf f10787a;
    private static final wze0 descriptor;

    static {
        gnf gnfVar = new gnf();
        f10787a = gnfVar;
        rh70 rh70Var = new rh70("org.xplatform.cyber.section.impl.leaderboard.data.model.CyberGamesOrganizationLeaderBoardResponse", gnfVar, 7);
        rh70Var.j("feedID", true);
        rh70Var.j("pos", true);
        rh70Var.j("year", true);
        rh70Var.j("name", true);
        rh70Var.j("imgS3", true);
        rh70Var.j("earnings", true);
    ...
    public final xdw[] childSerializers() {
        ...
        return new xdw[]{xdwVarY, xdwVarY2, xdwVarY3, vn4.Y(p0j0Var), vn4.Y(p0j0Var), vn4.Y(zxyVar), vn4.Y(fx7.f9602a)};
    }
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new inf(i, l, num, num2, str, str2, l2, bool);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        inf infVar = (inf) obj;
        infVar.getClass();
        Boolean bool = infVar.g;
        Long l = infVar.f;
        String str = infVar.e;
        String str2 = infVar.d;
        Integer num = infVar.c;
        Integer num2 = infVar.b;
        Long l2 = infVar.f14020a;
        wze0 wze0Var = descriptor;
