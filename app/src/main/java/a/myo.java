...
public final /* synthetic */ class myo implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final myo f21004a;
    private static final wze0 descriptor;

    static {
        myo myoVar = new myo();
        f21004a = myoVar;
        rh70 rh70Var = new rh70("org.xplatform.statistic.player.impl.player.career.data.models.FooterTableResponse", myoVar, 3);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new oyo(i, list, list2, list3);
    }
