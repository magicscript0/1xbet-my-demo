...
public final /* synthetic */ class chz implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final chz f4063a;
    private static final wze0 descriptor;

    static {
        chz chzVar = new chz();
        f4063a = chzVar;
        rh70 rh70Var = new rh70("org.xplatform.feed.linelive.data.models.MainFeedChampsResponse.SubLigaResponse", chzVar, 13);
        rh70Var.j("id", true);
        rh70Var.j("name", true);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        Long l4 = l;
        vccVarA.c(wze0Var);
        return new ehz(i, l3, str, str2, str3, str4, num2, str5, num, bool2, bool, l4, list, l2);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        List list = ehzVar.l;
        Long l2 = ehzVar.k;
        Boolean bool = ehzVar.j;
        Boolean bool2 = ehzVar.i;
        Integer num = ehzVar.h;
        String str = ehzVar.g;
        Integer num2 = ehzVar.f;
        String str2 = ehzVar.e;
        String str3 = ehzVar.d;
        String str4 = ehzVar.c;
        String str5 = ehzVar.b;
        Long l3 = ehzVar.f7323a;
        wze0 wze0Var = descriptor;
