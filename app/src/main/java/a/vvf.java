...
public final /* synthetic */ class vvf implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final vvf f35390a;
    private static final wze0 descriptor;

    static {
        vvf vvfVar = new vvf();
        f35390a = vvfVar;
        rh70 rh70Var = new rh70("org.xplatform.cyber.game.core.data.model.feed.CyberPeriodScoresResponse", vvfVar, 5);
    ...
    public final xdw[] childSerializers() {
        ...
        return new xdw[]{vn4.Y(egvVar), vn4.Y(egvVar), vn4.Y(egvVar), vn4.Y(p0j0.f24306a), vn4.Y(egvVar)};
    }
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new xvf(i, num, num2, num3, num4, str);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        xvf xvfVar = (xvf) obj;
        xvfVar.getClass();
        Integer num = xvfVar.e;
        String str = xvfVar.d;
        Integer num2 = xvfVar.c;
        Integer num3 = xvfVar.b;
        Integer num4 = xvfVar.f38660a;
        wze0 wze0Var = descriptor;
