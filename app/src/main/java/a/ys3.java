...
public final /* synthetic */ class ys3 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final ys3 f40153a;
    private static final wze0 descriptor;

    static {
        ys3 ys3Var = new ys3();
        f40153a = ys3Var;
        rh70 rh70Var = new rh70("org.xplatform.apple_fortune.data.models.responses.AppleFortuneScrollCellResponse", ys3Var, 11);
        rh70Var.j("AI", true);
        rh70Var.j("AN", true);
        rh70Var.j("BS", true);
        rh70Var.j("AP", true);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new at3(i, l, num, d2, list3, list4, d3, num2, d, razVar, list2, list);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        raz razVar = at3Var.i;
        Double d = at3Var.h;
        Integer num = at3Var.g;
        Double d2 = at3Var.f;
        List list3 = at3Var.e;
        List list4 = at3Var.d;
        Double d3 = at3Var.c;
        Integer num2 = at3Var.b;
        Long l = at3Var.f1318a;
        wze0 wze0Var = descriptor;
