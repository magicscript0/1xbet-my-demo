...
public final /* synthetic */ class iwu implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final iwu f14425a;
    private static final wze0 descriptor;

    static {
        iwu iwuVar = new iwu();
        f14425a = iwuVar;
        rh70 rh70Var = new rh70("org.xplatform.cyber.section.impl.feed.data.model.ImageCyberChampResponse", iwuVar, 4);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new kwu(i, str, str2, str3, str4);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        kwuVar.getClass();
        String str = kwuVar.d;
        String str2 = kwuVar.c;
        String str3 = kwuVar.b;
        String str4 = kwuVar.f17674a;
        wze0 wze0Var = descriptor;
