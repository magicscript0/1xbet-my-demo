...
public final /* synthetic */ class g4q0 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final g4q0 f9938a;
    private static final wze0 descriptor;

    static {
        g4q0 g4q0Var = new g4q0();
        f9938a = g4q0Var;
        rh70 rh70Var = new rh70("org.xplatform.cyber.game.core.data.model.games.victory_formula.VictoryFormulaLiveResponse", g4q0Var, 7);
        rh70Var.j("P1", true);
        rh70Var.j("P2", true);
        rh70Var.j("F1", true);
        rh70Var.j("F2", true);
    ...
    public final xdw[] childSerializers() {
        o0x[] o0xVarArr = i4q0.h;
        xdw xdwVarY = vn4.Y((xdw) o0xVarArr[0].getValue());
        xdw xdwVarY2 = vn4.Y((xdw) o0xVarArr[1].getValue());
        p0j0 p0j0Var = p0j0.f24306a;
        return new xdw[]{xdwVarY, xdwVarY2, vn4.Y(p0j0Var), vn4.Y(p0j0Var), vn4.Y(p0j0Var), vn4.Y(zxy.f41997a), vn4.Y(egv.f7269a)};
    }
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new i4q0(i, list, list2, str, str2, str3, l, num);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        i4q0Var.getClass();
        Integer num = i4q0Var.g;
        Long l = i4q0Var.f;
        String str = i4q0Var.e;
        String str2 = i4q0Var.d;
        String str3 = i4q0Var.c;
        List list = i4q0Var.b;
        List list2 = i4q0Var.f13180a;
        wze0 wze0Var = descriptor;
