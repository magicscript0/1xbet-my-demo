...
public final /* synthetic */ class uoj implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final uoj f33464a;
    private static final wze0 descriptor;

    static {
        uoj uojVar = new uoj();
        f33464a = uojVar;
        rh70 rh70Var = new rh70("org.xplatform.cyber.game.core.data.model.playerscomposition.dota.DotaPlayersCompositionResponse", uojVar, 4);
        rh70Var.j("name", true);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new woj(i, str, str2, str3, list);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        List list = wojVar.d;
        String str = wojVar.c;
        String str2 = wojVar.b;
        String str3 = wojVar.f36720a;
        wze0 wze0Var = descriptor;
