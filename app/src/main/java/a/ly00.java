...
public final /* synthetic */ class ly00 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final ly00 f19319a;
    private static final wze0 descriptor;

    static {
        ly00 ly00Var = new ly00();
        f19319a = ly00Var;
        rh70 rh70Var = new rh70("org.xplatform.statistic.match_progress.match_progress_main.data.models.MatchProgressResponse", ly00Var, 4);
        rh70Var.j("title", true);
        rh70Var.j("pointByPoints", true);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new ny00(i, num, num2, str, list);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        ny00Var.getClass();
        Integer num = ny00Var.d;
        Integer num2 = ny00Var.c;
        List list = ny00Var.b;
        String str = ny00Var.f22570a;
        wze0 wze0Var = descriptor;
