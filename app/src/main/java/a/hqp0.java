...
public final /* synthetic */ class hqp0 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final hqp0 f12559a;
    private static final wze0 descriptor;

    static {
        hqp0 hqp0Var = new hqp0();
        f12559a = hqp0Var;
        rh70 rh70Var = new rh70("org.xplatform.cyber.game.core.data.model.playerscomposition.valorant.ValorantPlayersCompositionResponse", hqp0Var, 7);
        rh70Var.j("id", true);
    ...
    public final xdw[] childSerializers() {
        o0x[] o0xVarArr = jqp0.h;
        zxy zxyVar = zxy.f41997a;
        xdw xdwVarY = vn4.Y(zxyVar);
        xdw xdwVarY2 = vn4.Y(zxyVar);
        p0j0 p0j0Var = p0j0.f24306a;
        return new xdw[]{xdwVarY, xdwVarY2, vn4.Y(p0j0Var), vn4.Y(fx7.f9602a), vn4.Y(p0j0Var), vn4.Y((xdw) o0xVarArr[5].getValue()), vn4.Y((xdw) o0xVarArr[6].getValue())};
    }
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new jqp0(i, l, l2, str, bool, str2, list, list2);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        jqp0Var.getClass();
        List list = jqp0Var.g;
        List list2 = jqp0Var.f;
        String str = jqp0Var.e;
        Boolean bool = jqp0Var.d;
        String str2 = jqp0Var.c;
        Long l = jqp0Var.b;
        Long l2 = jqp0Var.f15782a;
        wze0 wze0Var = descriptor;
