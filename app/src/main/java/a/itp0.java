...
public final /* synthetic */ class itp0 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final itp0 f14292a;
    private static final wze0 descriptor;

    static {
        itp0 itp0Var = new itp0();
        f14292a = itp0Var;
        rh70 rh70Var = new rh70("org.xplatform.cyber.game.valorant.impl.data.model.matches.team.ValorantStatisticMatchesTeamResponse", itp0Var, 6);
        rh70Var.j("id", true);
    ...
    public final xdw[] childSerializers() {
        o0x[] o0xVarArr = ktp0.g;
        xdw xdwVarY = vn4.Y(egv.f7269a);
        xdw xdwVarY2 = vn4.Y(zxy.f41997a);
        p0j0 p0j0Var = p0j0.f24306a;
        return new xdw[]{xdwVarY, xdwVarY2, vn4.Y(p0j0Var), vn4.Y(p0j0Var), vn4.Y(fx7.f9602a), vn4.Y((xdw) o0xVarArr[5].getValue())};
    }
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new ktp0(i, num, l, str, str2, bool, list);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ktp0 ktp0Var = (ktp0) obj;
        ktp0Var.getClass();
        List list = ktp0Var.f;
        Boolean bool = ktp0Var.e;
        String str = ktp0Var.d;
        String str2 = ktp0Var.c;
        Long l = ktp0Var.b;
        Integer num = ktp0Var.f17544a;
        wze0 wze0Var = descriptor;
