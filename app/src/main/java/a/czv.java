...
public final /* synthetic */ class czv implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final czv f4846a;
    private static final wze0 descriptor;

    static {
        czv czvVar = new czv();
        f4846a = czvVar;
        rh70 rh70Var = new rh70("org.xplatform.bethistory.history.data.models.response.jackpot.JackpotCouponResponse", czvVar, 16);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        String str6 = str5;
        vccVarA.c(wze0Var);
        return new gzv(i, l4, num6, str6, d3, d5, l2, str4, num3, num2, d2, str, num5, str2, str3, list, uysVar);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        List list = gzvVar.o;
        String str = gzvVar.n;
        String str2 = gzvVar.m;
        Integer num = gzvVar.l;
        String str3 = gzvVar.k;
        Double d = gzvVar.j;
        Integer num2 = gzvVar.i;
        Integer num3 = gzvVar.h;
        String str4 = gzvVar.g;
        Long l = gzvVar.f;
        Double d2 = gzvVar.e;
        Double d3 = gzvVar.d;
        String str5 = gzvVar.c;
        Integer num4 = gzvVar.b;
        Long l2 = gzvVar.f11337a;
        wze0 wze0Var = descriptor;
