...
public final /* synthetic */ class zor implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final zor f41594a;
    private static final wze0 descriptor;

    static {
        zor zorVar = new zor();
        f41594a = zorVar;
        rh70 rh70Var = new rh70("org.xplatform.client1.geo.api.data.model.GeoIpData", zorVar, 7);
        rh70Var.j(CommonConstant.KEY_COUNTRY_CODE, true);
        rh70Var.j("countryName", true);
        rh70Var.j("regionName", true);
        rh70Var.j("cityName", true);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new bpr(i, str, str2, str3, str4, num, l, num2);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        bpr bprVar = (bpr) obj;
        bprVar.getClass();
        Integer num = bprVar.g;
        Long l = bprVar.f;
        Integer num2 = bprVar.e;
        String str = bprVar.d;
        String str2 = bprVar.c;
        String str3 = bprVar.b;
        String str4 = bprVar.f2787a;
        wze0 wze0Var = descriptor;
