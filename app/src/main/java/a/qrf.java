...
public final /* synthetic */ class qrf implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final qrf f27128a;
    private static final wze0 descriptor;

    static {
        qrf qrfVar = new qrf();
        f27128a = qrfVar;
        rh70 rh70Var = new rh70("org.xplatform.cyber.game.core.data.model.playerscomposition.lol.CyberLolPlayerHeroesResponse", qrfVar, 6);
        rh70Var.j("name", true);
    ...
    public final xdw[] childSerializers() {
        ...
        return new xdw[]{xdwVarY, xdwVarY2, xdwVarY3, vn4.Y(rujVar), vn4.Y(rujVar), vn4.Y(egv.f7269a)};
    }
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new srf(i, str, str2, str3, d, d2, num);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        srf srfVar = (srf) obj;
        srfVar.getClass();
        Integer num = srfVar.f;
        Double d = srfVar.e;
        Double d2 = srfVar.d;
        String str = srfVar.c;
        String str2 = srfVar.b;
        String str3 = srfVar.f30336a;
        wze0 wze0Var = descriptor;
