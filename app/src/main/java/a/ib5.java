...
public final /* synthetic */ class ib5 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final ib5 f13473a;
    private static final wze0 descriptor;

    static {
        ib5 ib5Var = new ib5();
        f13473a = ib5Var;
        rh70 rh70Var = new rh70("org.xplatform.background_video.impl.data.models.BackgroundResponse", ib5Var, 6);
        rh70Var.j("$SMALL_VIDEO", true);
        rh70Var.j("$SMALL_PREVIEW", true);
        rh70Var.j("$MEDIUM_VIDEO", true);
        rh70Var.j("$MEDIUM_PREVIEW", true);
        rh70Var.j("$LARGE_VIDEO", true);
        rh70Var.j("$LARGE_PREVIEW", true);
        descriptor = rh70Var;
    }
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new kb5(i, str, str2, str3, str4, str5, str6);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        kb5Var.getClass();
        String str = kb5Var.f;
        String str2 = kb5Var.e;
        String str3 = kb5Var.d;
        String str4 = kb5Var.c;
        String str5 = kb5Var.b;
        String str6 = kb5Var.f16715a;
        wze0 wze0Var = descriptor;
