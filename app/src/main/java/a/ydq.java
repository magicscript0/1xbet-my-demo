...
public final /* synthetic */ class ydq implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final ydq f39506a;
    private static final wze0 descriptor;

    static {
        ydq ydqVar = new ydq();
        f39506a = ydqVar;
        rh70 rh70Var = new rh70("org.xplatform.statistic.game_events.data.model.GameEventsBaseResponse", ydqVar, 4);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new aeq(i, num, list, list2, list3);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        aeqVar.getClass();
        List list = aeqVar.d;
        Integer num = aeqVar.c;
        List list2 = aeqVar.b;
        List list3 = aeqVar.f677a;
        wze0 wze0Var = descriptor;
