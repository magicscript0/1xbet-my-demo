...
public final /* synthetic */ class xdu implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final xdu f37875a;
    private static final wze0 descriptor;

    static {
        xdu xduVar = new xdu();
        f37875a = xduVar;
        rh70 rh70Var = new rh70("org.xplatform.cyber.section.impl.championships.hltv_awards.data.model.HltvAwardsPreviousWinnersResponse", xduVar, 8);
        rh70Var.j("id", true);
        rh70Var.j("name", true);
    ...
    public final xdw[] childSerializers() {
        ...
        return new xdw[]{xdwVarY, xdwVarY2, xdwVarY3, xdwVarY4, vn4.Y(egvVar), vn4.Y(egvVar), vn4.Y(zxyVar), vn4.Y(zxyVar)};
    }
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        while (z) {
            ...
            switch (iF) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    l4 = (Long) vccVarA.e(wze0Var, 7, zxy.f41997a, l4);
                    i |= 128;
                    break;
                default:
                    emp0.c(iF);
        ...
        vccVarA.c(wze0Var);
        return new zdu(i, l, str, str2, l2, num, num2, l3, l4);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        Long l = zduVar.h;
        Long l2 = zduVar.g;
        Integer num = zduVar.f;
        Integer num2 = zduVar.e;
        Long l3 = zduVar.d;
        String str = zduVar.c;
        String str2 = zduVar.b;
        Long l4 = zduVar.f41111a;
        wze0 wze0Var = descriptor;
