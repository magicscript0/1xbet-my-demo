...
public final /* synthetic */ class ylf implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final ylf f39854a;
    private static final wze0 descriptor;

    static {
        ylf ylfVar = new ylf();
        f39854a = ylfVar;
        rh70 rh70Var = new rh70("org.xplatform.cyber.section.impl.leaderboard.data.model.CyberGamesCSRankingLeaderBoardTeamsResponse", ylfVar, 7);
    ...
    public final xdw[] childSerializers() {
        ...
        return new xdw[]{xdwVarY, vn4.Y(p0j0Var), vn4.Y(p0j0Var), vn4.Y(p0j0Var), vn4.Y(egv.f7269a), vn4.Y(zxyVar), vn4.Y((xdw) o0xVarArr[6].getValue())};
    }
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new amf(i, l, str, str2, str3, num, l2, list);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        List list = amfVar.g;
        Long l = amfVar.f;
        Integer num = amfVar.e;
        String str = amfVar.d;
        String str2 = amfVar.c;
        String str3 = amfVar.b;
        Long l2 = amfVar.f1022a;
        wze0 wze0Var = descriptor;
