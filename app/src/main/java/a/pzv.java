...
public final /* synthetic */ class pzv implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final pzv f25910a;
    private static final wze0 descriptor;

    static {
        pzv pzvVar = new pzv();
        f25910a = pzvVar;
        rh70 rh70Var = new rh70("org.xplatform.bet_history.history.data.model.toto.JackpotGameResponse", pzvVar, 25);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        Long l14 = l10;
        Long l15 = l6;
        return new tzv(i2, l12, l13, str11, str5, bool, bool2, str6, str7, l9, l14, str8, str9, num2, str10, list, list2, num3, num4, l5, l15, str2, str, l4, l3, l11);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        Long l3 = tzvVar.w;
        String str = tzvVar.v;
        String str2 = tzvVar.u;
        Long l4 = tzvVar.t;
        Long l5 = tzvVar.s;
        Integer num = tzvVar.r;
        Integer num2 = tzvVar.q;
        List list = tzvVar.p;
        List list2 = tzvVar.o;
        String str3 = tzvVar.n;
        Integer num3 = tzvVar.m;
        String str4 = tzvVar.l;
        String str5 = tzvVar.k;
        Long l6 = tzvVar.j;
        Long l7 = tzvVar.i;
        String str6 = tzvVar.h;
        String str7 = tzvVar.g;
        Boolean bool = tzvVar.f;
        Boolean bool2 = tzvVar.e;
        String str8 = tzvVar.d;
        String str9 = tzvVar.c;
        Long l8 = tzvVar.b;
        Long l9 = tzvVar.f32332a;
        wze0 wze0Var = descriptor;
