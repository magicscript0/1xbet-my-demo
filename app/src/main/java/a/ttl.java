...
public final /* synthetic */ class ttl implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final ttl f32060a;
    private static final wze0 descriptor;

    static {
        ttl ttlVar = new ttl();
        f32060a = ttlVar;
        rh70 rh70Var = new rh70("org.xplatform.eastern_nights.data.models.responses.EasternNightsScrollCellResponse", ttlVar, 11);
        rh70Var.j("AI", true);
        rh70Var.j("AN", true);
        rh70Var.j("BS", true);
        rh70Var.j("AP", true);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new vtl(i, l, num, d2, list3, list4, d3, num2, d, razVar, list2, list);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        raz razVar = vtlVar.i;
        Double d = vtlVar.h;
        Integer num = vtlVar.g;
        Double d2 = vtlVar.f;
        List list3 = vtlVar.e;
        List list4 = vtlVar.d;
        Double d3 = vtlVar.c;
        Integer num2 = vtlVar.b;
        Long l = vtlVar.f35314a;
        wze0 wze0Var = descriptor;
