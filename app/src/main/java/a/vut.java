...
public final /* synthetic */ class vut implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final vut f35361a;
    private static final wze0 descriptor;

    static {
        vut vutVar = new vut();
        f35361a = vutVar;
        rh70 rh70Var = new rh70("org.xplatform.statistic.heat_map.impl.data.models.HeatMapStatisticResponse", vutVar, 4);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new xut(i, num, list, list2, list3);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        xutVar.getClass();
        List list = xutVar.d;
        Integer num = xutVar.c;
        List list2 = xutVar.b;
        List list3 = xutVar.f38633a;
        wze0 wze0Var = descriptor;
