...
public final class wq3 extends vq3 {
    public final dyj0 r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public wq3(Context context, Intent intent) {
        super(context, intent, 0);
        context.getClass();
        intent.getClass();
        this.r = b3x.b(new px1(this, 18));
    }
