...
public final /* synthetic */ class ou6 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final ou6 f24015a;
    private static final wze0 descriptor;

    static {
        ou6 ou6Var = new ou6();
        f24015a = ou6Var;
        rh70 rh70Var = new rh70("org.xplatform.bet_history.edit_coupon.data.model.BetInfoResponse", ou6Var, 14);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        Integer num6 = num5;
        vccVarA.c(wze0Var);
        return new su6(i, num6, l, num3, d4, num4, l2, str3, d3, str2, str, list, d5, d2, num2);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        su6 su6Var = (su6) obj;
        su6Var.getClass();
        Integer num = su6Var.n;
        Double d = su6Var.m;
        Double d2 = su6Var.l;
        List list = su6Var.k;
        String str = su6Var.j;
        String str2 = su6Var.i;
        Double d3 = su6Var.h;
        String str3 = su6Var.g;
        Long l = su6Var.f;
        Integer num2 = su6Var.e;
        Double d4 = su6Var.d;
        Integer num3 = su6Var.c;
        Long l2 = su6Var.b;
        Integer num4 = su6Var.f30457a;
        wze0 wze0Var = descriptor;
