...
public final class a160 extends jhw {
    public Path q;
    public final jhw r;

    public a160(g0z g0zVar, jhw jhwVar) {
        super(g0zVar, (PointF) jhwVar.b, (PointF) jhwVar.c, jhwVar.d, jhwVar.e, jhwVar.f, jhwVar.g, jhwVar.h);
        this.r = jhwVar;
        d();
    }
    ...
    public final void d() {
        ...
        jhw jhwVar = this.r;
        PointF pointF4 = jhwVar.o;
        PointF pointF5 = jhwVar.p;
