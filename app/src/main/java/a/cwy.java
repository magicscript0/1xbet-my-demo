...
public final /* synthetic */ class cwy implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final cwy f4713a;
    private static final wze0 descriptor;

    static {
        cwy cwyVar = new cwy();
        f4713a = cwyVar;
        rh70 rh70Var = new rh70("org.xplatform.cyber.lol.impl.data.model.matches.LolStatisticMatchesTeamResponse", cwyVar, 4);
        rh70Var.j("id", true);
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new ewy(i, num, l, str, str2);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        ewyVar.getClass();
        String str = ewyVar.d;
        String str2 = ewyVar.c;
        Long l = ewyVar.b;
        Integer num = ewyVar.f7979a;
        wze0 wze0Var = descriptor;
