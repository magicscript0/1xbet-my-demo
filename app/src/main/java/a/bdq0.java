...
public abstract class bdq0 {
    ...
    public final float b(float f, long j, k0i k0iVar, View view) {
        this.f2264a.g0(f, this.g);
        float[] fArr = this.g;
        boolean z = true;
        float f2 = fArr[1];
        if (f2 == 0.0f) {
    ...
    public abstract boolean d(float f, long j, k0i k0iVar, View view);
    ...
    public void e(int i) {
        ...
        this.f2264a = in6.Z(i, dArr, dArr2);
    }
    ...
    public final String toString() {
        ...
        for (int i = 0; i < this.e; i++) {
            ...
            sbQ.append(this.c[i]);
            sbQ.append(" , ");
            sbQ.append(decimalFormat.format(this.d[i]));
            sbQ.append("] ");
            string = sbQ.toString();
        }
        return string;
