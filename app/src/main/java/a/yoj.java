...
public final /* synthetic */ class yoj implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final yoj f39992a;
    private static final wze0 descriptor;

    static {
        yoj yojVar = new yoj();
        f39992a = yojVar;
        rh70 rh70Var = new rh70("org.xplatform.cyber.section.impl.leaderboard.data.model.DotaPlayersLeaderBoardResponse", yojVar, 7);
        rh70Var.j("region", true);
        rh70Var.j("rank", true);
        rh70Var.j("name", true);
        rh70Var.j("imageS3", true);
        rh70Var.j("teamFeedId", true);
    ...
    public final xdw[] childSerializers() {
        ...
        return new xdw[]{vn4.Y(p0j0Var), vn4.Y(egv.f7269a), vn4.Y(p0j0Var), vn4.Y(p0j0Var), vn4.Y(zxy.f41997a), vn4.Y(p0j0Var), vn4.Y(p0j0Var)};
    }
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new apj(i, str, num, str2, str3, l, str4, str5);
    }
    ...
    public final void serialize(x7m x7mVar, Object obj) {
        ...
        apjVar.getClass();
        String str = apjVar.g;
        String str2 = apjVar.f;
        Long l = apjVar.e;
        String str3 = apjVar.d;
        String str4 = apjVar.c;
        Integer num = apjVar.b;
        String str5 = apjVar.f1158a;
        wze0 wze0Var = descriptor;
