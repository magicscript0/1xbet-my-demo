...
public final class r310 extends m310 {
    public final float g;
    public final float h;

    public r310(View view) {
        super(view);
    ...
    public final AnimatorSet a() {
        ...
        animatorSet.setInterpolator(new fan(1));
        return animatorSet;
    }

    public final void b(float f) {
        float interpolation = this.f19558a.getInterpolation(f);
        View view = this.b;
        ...
        float fA = 1.0f - i93.a(0.0f, f2, interpolation);
        float fA2 = 1.0f - i93.a(0.0f, f3, interpolation);
