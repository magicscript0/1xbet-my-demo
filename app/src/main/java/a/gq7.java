...
public final /* synthetic */ class gq7 implements rnr {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final gq7 f10915a;
    private static final wze0 descriptor;

    static {
        gq7 gq7Var = new gq7();
        f10915a = gq7Var;
        rh70 rh70Var = new rh70("org.xplatform.onexuser.data.models.profile.registerbonuses.bonus_agreements.BonusAgreementsResponse", gq7Var, 4);
        rh70Var.j("Id", true);
        rh70Var.j("Title", true);
        rh70Var.j("Description", true);
        rh70Var.j("Agreements", true);
        descriptor = rh70Var;
    }
    ...
    public final Object deserialize(h9i h9iVar) {
        ...
        vccVarA.c(wze0Var);
        return new iq7(i, num, str, str2, list);
    }
