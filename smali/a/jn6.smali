.class public abstract synthetic La/jn6;
...
.method public static bridge synthetic A(Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    .line 1
    const-string v0, "HISTORY_MENU_ITEM_RESULT"

    const-class v1, Lorg/xplatform/bet_history/history/domain/model/HistoryMenuItem;
...
.method public static bridge synthetic B(Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    .line 1
    const-string v0, "KEY_BUNDLE_CONFIRMATION_NEW_PLACE"

    const-class v1, Lorg/xplatform/security/api/presentation/models/ConfirmationNewPlaceResultType;
...
.method public static bridge synthetic C(Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    .line 1
    const-string v0, "FILE_DIALOG_RESULT_RESULT_KEY"

    const-class v1, Lorg/xplatform/consultantchat/presentation/dialogs/file/model/FileBottomDialogResult;
...
.method public static bridge synthetic D(Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    .line 1
    const-string v0, "SEND_RATING_REQUEST_RESULT"

    const-class v1, Lorg/xplatform/consultantchat/presentation/dialogs/rate/model/RatingModel$Value;
...
.method public static bridge synthetic n(La/i8c;)Landroid/window/OnBackInvokedDispatcher;
    .locals 0
...
.method public static bridge synthetic o(La/n8c;)Landroid/window/OnBackInvokedDispatcher;
    .locals 0
...
.method public static bridge synthetic p(Landroid/os/Bundle;)Ljava/io/Serializable;
    ...
    .line 1
    const-string v0, "SELECT_SORT_TYPE_REQUEST_KEY"
...
.method public static bridge synthetic q(Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    .line 1
    const-string v0, "HISTORY_DATE_FILTER_REQUEST"

    const-class v1, Lorg/xplatform/bet_history/history/presentation/dialog/history_data_filter/model/HistoryDateFilterTypeModel;
...
.method public static bridge synthetic s(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageManager$ApplicationInfoFlags;)Ljava/util/List;
    .locals 0
...
.method public static bridge synthetic u()Landroid/content/pm/PackageManager$ResolveInfoFlags;
    .locals 2
...
.method public static bridge synthetic v(Landroid/content/pm/PackageManager;Landroid/content/Intent;Landroid/content/pm/PackageManager$ResolveInfoFlags;)Landroid/content/pm/ResolveInfo;
    .locals 0
...
.method public static bridge synthetic y(Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    .line 1
    const-string v0, "REQUEST_HISTORY_KEY"
...
.method public static bridge synthetic z(Landroid/content/pm/PackageManager;Landroid/content/Intent;Landroid/content/pm/PackageManager$ResolveInfoFlags;)Ljava/util/List;
    .locals 0
